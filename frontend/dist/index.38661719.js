...
ws.open = ()=>undefined.setSocketStatus("open")
;
ws.onclose = ()=>undefined.setSocketStatus("closed")
;
let player1ID;
let player2ID;
ws.onmessage = (e)=>{
    ...
    } else if (message.kind === "update") console.log("receiving update", JSON.parse(message.content));
    else undefined.setReceivedData("received message response", JSON.parse(message.content));
};
setTimeout(()=>{
    const message = {
        kind: "checkField",
...
},{"./test":"1wubG"}],"1wubG":[function(require,module,exports) {
console.log("test");

},{}]},["5UGAA","7BQdY"], "7BQdY", "parcelRequire10c2")
